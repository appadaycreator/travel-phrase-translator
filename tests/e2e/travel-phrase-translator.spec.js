...
const SVC_URL = "https://appadaycreator.com/travel-phrase-translator/";
const SVC_NAME = "海外旅行フレーズ変換ツール";

test.describe("海外旅行フレーズ変換ツール - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("travel-phrase-translator");
